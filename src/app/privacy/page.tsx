  ...
  return (
    <div className="max-w-3xl mx-auto py-16 px-4 prose prose-zinc">
      ...
      <div className="space-y-6 text-zinc-600 leading-relaxed">
        ...
        <p>YTClipper does not require you to create an account. We do not collect or store personal identifying information. We may temporarily log IP addresses for rate limiting purposes to prevent abuse of our services.</p>
