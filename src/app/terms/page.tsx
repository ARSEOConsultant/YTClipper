...
export const metadata = {
  title: 'Terms of Service - UFetchTube',
  description: 'Terms of Service for UFetchTube.',
  ...
  return (
    <div className="max-w-3xl mx-auto py-16 px-4 prose prose-zinc">
      ...
      <div className="space-y-6 text-zinc-600 leading-relaxed">
        ...
        <p>By accessing and using UFetchTube, you accept and agree to be bound by the terms and provision of this agreement.</p>

        <h2 className="text-xl font-semibold text-zinc-900">2. Copyright and Usage Rights</h2>
        <p>UFetchTube is a tool designed to help users process videos they own, have permission to use, or that are licensed for reuse. You agree not to use this service to download copyrighted material without permission. We do not support bypassing DRM or downloading protected content.</p>
        ...
        <p>In no event shall UFetchTube be liable for any direct, indirect, incidental, special or consequential damages arising out of or in any way connected with the use of this service.</p>
      </div>
    </div>
  );
}
